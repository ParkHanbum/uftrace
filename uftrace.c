...
int 
__attribute__((weak)) command_dynamic(int argc, char *argv[], struct opts *opts) 
{
	printf("your uftrace have compiled without capstone library.\n");
	printf("therefore, you cannot use dynamic tracing feature.\n");
	return 0;
}
